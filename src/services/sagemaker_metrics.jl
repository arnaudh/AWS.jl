...
Used to ingest training metrics into SageMaker which can be visualized in SageMaker Studio
and retrieved with the GetMetrics API.

# Arguments
- `metric_data`: A list of raw metric values to put.
- `trial_component_name`: The name of Trial Component to associate the metrics with.
